...
clean_up(){
	...
	sleep 10 && rm -rfv $FILENAME_XML salmone-lexicon-tashkeel.txt salmone-lexicon-no-tashkeel.txt salmone-lexicon-no-tashkeel.index salmone-lexicon-no-tashkeel.dict salmone-lexicon-tashkeel.index salmone-lexicon-tashkeel.dict
}
